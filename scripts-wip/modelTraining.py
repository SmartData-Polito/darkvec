...
def update_runtimes(key, val):
    ...
    RUNTIMES = f'{DATASETS}/runtimes.json'
...
def update_corpus(mname, corpus):
    ...
    with open(f'{DATASETS}/corpus_stats.json', 'w') as file:
...
SAVE = True
params = {'corpus':{'services':'auto', 'without_duplicates':True, 'top_ports':2500},
       'word2vec':{'c':25, 'e':50, 'epochs':1, 'method':'incremental'}}


mname = f'soa_incremental_{params["corpus"]["services"]}'
